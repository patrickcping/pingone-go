...
func (r ApiV1EnvironmentsEnvIDImagesImgIDDeleteRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDImagesImgIDDeleteRequest {
...
func (r ApiV1EnvironmentsEnvIDImagesImgIDGetRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDImagesImgIDGetRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDImagesPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDImagesPostRequest {
	r.authorization = &authorization
	return r
}
