...
func (r ApiV1RolesGetRequest) Authorization(authorization string) ApiV1RolesGetRequest {
...
func (r ApiV1RolesRoleIDGetRequest) Authorization(authorization string) ApiV1RolesRoleIDGetRequest {
	r.authorization = &authorization
	return r
}
