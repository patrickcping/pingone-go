...
func (r ApiV1EnvironmentsEnvIDCapabilitiesGetRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDCapabilitiesGetRequest {
...
func (r ApiV1OrganizationsOrgIDCapabilitiesGetRequest) Authorization(authorization string) ApiV1OrganizationsOrgIDCapabilitiesGetRequest {
	r.authorization = &authorization
	return r
}
