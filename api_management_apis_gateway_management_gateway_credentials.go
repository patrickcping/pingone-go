...
func (r ApiV1EnvironmentsEnvIDGatewaysGatewayIDCredentialsCredentialIDDeleteRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDGatewaysGatewayIDCredentialsCredentialIDDeleteRequest {
...
func (r ApiV1EnvironmentsEnvIDGatewaysGatewayIDCredentialsPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDGatewaysGatewayIDCredentialsPostRequest {
	r.authorization = &authorization
	return r
}
