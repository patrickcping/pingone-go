...
func (r ApiV1EnvironmentsEnvIDPropagationStoreMetadataAqueraPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDPropagationStoreMetadataAqueraPostRequest {
...
func (r ApiV1EnvironmentsEnvIDPropagationStoreMetadataSalesforceContactsPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDPropagationStoreMetadataSalesforceContactsPostRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDPropagationStoreMetadataSalesforcePostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDPropagationStoreMetadataSalesforcePostRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDPropagationStoreMetadataScimPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDPropagationStoreMetadataScimPostRequest {
	r.authorization = &authorization
	return r
}
