...
func (r ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusGetRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusGetRequest {
...
func (r ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDDeleteRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDDeleteRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDGetRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDGetRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDPutRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusL10nStatusIDPutRequest {
	r.authorization = &authorization
	return r
}
...
func (r ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusPostRequest) Authorization(authorization string) ApiV1EnvironmentsEnvIDLanguagesLanguageIDStatusPostRequest {
	r.authorization = &authorization
	return r
}
