...
*/
func (a *DeviceAuthenticationPolicyApiService) V1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPut(ctx context.Context, envID string, deviceAuthPolicyID string) ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPutRequest {
	return ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPutRequest{
		ApiService: a,
		ctx: ctx,
		envID: envID,
...
func (a *DeviceAuthenticationPolicyApiService) V1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPutExecute(r ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPutRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAuthenticationPolicyApiService.V1EnvironmentsEnvIDDeviceAuthenticationPolicyDeviceAuthPolicyIDPut")
	if err != nil {
...
*/
func (a *DeviceAuthenticationPolicyApiService) V1EnvironmentsEnvIDDeviceAuthenticationPolicyGet(ctx context.Context, envID string) ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyGetRequest {
	return ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyGetRequest{
		ApiService: a,
		ctx: ctx,
		envID: envID,
...
// Execute executes the request
func (a *DeviceAuthenticationPolicyApiService) V1EnvironmentsEnvIDDeviceAuthenticationPolicyGetExecute(r ApiV1EnvironmentsEnvIDDeviceAuthenticationPolicyGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeviceAuthenticationPolicyApiService.V1EnvironmentsEnvIDDeviceAuthenticationPolicyGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
